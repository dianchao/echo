...
import cn.mldn.http.server.client.handler.EchoClientHandler2;
import cn.mldn.http.server.client.handler.EchoClientHandler3;
            ...
            client.group(group).channel(NioSocketChannel.class)
                    ...
                    .handler(new ChannelInitializer<SocketChannel>() {
                        ...
                        protected void initChannel(SocketChannel socketChannel) throws Exception {
                            ...
                            socketChannel.pipeline().addLast(new EchoClientHandler3()); // 追加了处理器
                        }
                    });
